...
## Concept sets
One concept set has been defined per use case.
Here we collect the details for all concepts in the concept set (excluding descendants),
this includes the concept name, standard status, domain, vocabulary, and more details.
